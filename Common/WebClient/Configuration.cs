...
namespace WebClient
{
    ...
    public static class Configuration
    {
        ...
        private const string DefaultServiceName = "S-Nest WebClient";
        private const string DefaultServiceDisplayName = "_S-Nest WebClient";
        private const string DefaultServiceDescription = "S-Nest WebClient Service Host";
